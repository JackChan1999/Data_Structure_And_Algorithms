...
数据和索引分开存储，存储数据的数组不变，真正表示堆的是索引数组，在堆的调整过程中改变的是索引数组。

- 普通堆和索引堆的初始状态和构建成堆后的状态

![](images/Heap.png)

![](images/IndexHeap.png)
...
![](images/IndexMaxHeap.png)

比较的时候比较的是data，真正交换的时候交换的是索引。

![](images/IndexMaxHeap2.png)
